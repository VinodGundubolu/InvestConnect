        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <div className="space-y-2 text-sm">
              <p><span className="font-medium">Name:</span> {investor.firstName} {investor.lastName}</p>
              <p><span className="font-medium">Email:</span> {investor.email}</p>
              <p><span className="font-medium">Investment:</span> {formatCurrency(investor.investmentAmount)}</p>
              <p><span className="font-medium">Bonds:</span> {investor.bondsCount} units</p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between bg-white rounded p-3 border">
              <div className="flex-1">
                ...
                <p className="font-mono text-lg">{investor.username}</p>
              </div>
              <Button
                variant="ghost"
                size="sm"
            ...
            <div className="flex items-center justify-between bg-white rounded p-3 border">
              <div className="flex-1">
                ...
                <p className="font-mono text-lg">
                  {showPassword ? investor.password : "••••••••"}
                </p>
              </div>
